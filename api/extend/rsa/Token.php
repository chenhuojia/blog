...
class Token{
    ...
    public  function set_private_key_sign($data){
        if (!$pi_key=$this->check_private_key()){
     ...
     * @return boolean|string
     * ***/
    public  function get_private_key_sign($sign){
        if (!$pi_key=$this->check_private_key()){
            $this->error='私钥不存在';
            return false;
        }
     ...
     * @return boolean|string
     * ***/
    public  function set_public_key_sign($data){
        if (!$pu_key=$this->check_public_key()){
            $this->error='公钥不存在';
            return false;
        }
        if ($pu_key =  openssl_pkey_get_public($pu_key)){
            $encrypted = "";
